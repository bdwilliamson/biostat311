---
title: "Group Data Analysis Project"
...
Each of the following components of the project has its own guidelines, each listed in separate documents.
...
3. You must be able to pose an interesting scientific question (judged by us) that you can answer using the data
