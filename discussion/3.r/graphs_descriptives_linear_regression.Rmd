...
FEV is a biological measurement, and it might be reasonable to assume that changes to FEV happen on a multiplicative scale rather than an additive scale. Let's explore how our results and interpretation change if we log transform FEV. 
