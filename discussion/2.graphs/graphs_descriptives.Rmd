...
What do you notice about this plot? Is it informative? What does the code `fev$fev[fev$teen == 0]` do? (Hint: `==` means "compare the left- and right-hand sides and check if they are equal")
