...
\setbeamertemplate{footline}{%
  \raisebox{5pt}{\makebox[\paperwidth]{\makebox[120pt]{\scriptsize Last updated \today}\hfill\makebox[10pt]{\scriptsize 0.0~~}}}}
...
% this is no longer relevant (used older version of uwIntroStats package)
%\begin{frame}
%\frametitle{Statistical Inference: FEV vs Sex}
%
...
% point out bug in uwIntroStats package
\begin{frame}
...
% re-run with updates uwIntroStats package
\begin{frame}[noframenumbering]
\frametitle{What's wrong here?}
