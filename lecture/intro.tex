...
\center \includegraphics[height=0.9\textheight]{./intro_boxplot} % boxplot of age grp vs FEV
\end{frame}
...
\begin{frame}
\frametitle{Example: Age and FEV} % FEV data
\center \includegraphics[height=0.9\textheight]{./intro_scatterplot} %scatterplot of age vs FEV; why isn't this the same as the dataset we used on our poster?????
\end{frame}
