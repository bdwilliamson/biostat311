...
\begin{itemize}
\item[] $p_M \not= p_F$ \textcolor{blue}{(probs)} \quad \quad \quad \quad \pause $\frac{p_M}{1-p_M} \not= \frac{p_F}{1-p_F}$ \textcolor{blue}{(odds)} \pause
...
On the same piece of paper, please answer these questions:
