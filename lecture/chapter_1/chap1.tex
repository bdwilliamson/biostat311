...
\item[] (We know how to interpret. Today we'll talk about how to calculate.)
\end{itemize}
...
% how to construct CI
% include discussion of CI interpretation dice rolling anlogy
...
\begin{frame}
\frametitle{Evaluating the association between lung function and age}

% include discussion of R code and output
...
\begin{frame}
\frametitle{Evaluating the association between lung function and sex}

% aside: connect to t-tests
