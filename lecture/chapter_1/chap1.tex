...
\begin{frame}
\frametitle{Multiple regression: motivation}
The true relationship between $Y$ and $X_1$ on the previous slides is \vspace{-0.5cm}
\begin{align*}
...
If, before running your analysis, I told you that $X_2$ was \textcolor{red}{associated with the outcome} (through this relationship with the mean of $Y$) and \textcolor{red}{associated with $X_1$ in our sample}, what would you call $X_2$? 

How might you \textbf{adjust} for $X_2$, accounting for these facts in your analysis?

What happened when we did not account for $X_2$ in the analysis?
...
\centering
\includegraphics[width = 0.7\textwidth]{plots/effect_modification_simple.png}
\end{frame}
...
\centering
\includegraphics[width = 0.7\textwidth]{plots/effect_modification_simple_with_line.png}
\end{frame}
...
\centering
\includegraphics[width=0.7\textwidth]{plots/effect_modification_colored.png}
...
\centering
\includegraphics[width=0.7\textwidth]{plots/effect_modification_colored_with_simple_line.png}
...
\centering
\includegraphics[width=0.7\textwidth]{plots/effect_modification_colored_with_lines.png}
...
\textcolor{red}{Confounders} (slides 1.66--1.71), \textcolor{blue}{effect modifiers} (slides 1.72--1.XX), and \textcolor{green}{precision variables} (slides 1.XX--1.YY) all show up in other types of regression as well.

Additionally, the types of considerations we will have to make when choosing variables for our analysis, and the interpretation of regression coefficients, will be similar.
...
\begin{frame}
\frametitle{``Multiple'' regression: stratified analyses}
One way to account for a second predictor variable is to \textbf{stratify}
...
\begin{align*}
E(Y \mid X) &= \beta_0^* + \beta_1^* X + \beta_2^* Z
\end{align*}
\end{frame}
