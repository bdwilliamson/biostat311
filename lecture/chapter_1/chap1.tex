...
\begin{frame}
\frametitle{Types for covariates: confounders}
...
\begin{frame}
\frametitle{Types for covariates: effect modifiers}
...
\begin{frame}
\frametitle{Types for covariates: precision variables}

\textcolor{green}{Precision variable}: associated with the outcome in the population, \textbf{not associated with} the predictor of interest.

\centering
 \includegraphics[width=0.7\textwidth]{plots/precision_colored_with_multiple_lines.png}
\end{frame}
