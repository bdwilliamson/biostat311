...
\textcolor{red}{Confounders}, \textcolor{blue}{effect modifiers}, and \textcolor{green}{precision variables} all show up in other types of regression, as well.
...
How might you add in an additional variable, $Z$?
\end{frame}
