...
\pause
Suppose we have a \textbf{scientific question:} \textit{is there an association between FEV and age?}

Then, we can use linear regression to answer this question.

 How? (1) Fit the model $E[FEV|age] = \beta_0 + \beta_1 \times age$, then (2) check whether or not $\beta_1 = 0$!
