...
# 1. FEV Descriptive Statistics (5.5 points) 
...
*(You do not need to report the table, just run the command and look at what's created in the console so you can answer the following questions.)* Note that in this dataset, "smoke = 1" denotes smokers and "smoke = 2" denotes nonsmokers. **Looking at the table you created using the `descrip` function, what are the lung capacities in each group? Is this result surprising?**

Type your answer to this problem here.

## d. (0.5 points) Provide a histogram of FEV for smokers and nonsmokers, separately. Use the histograms to qualitatiely characterize the difference in the distribution of FEV between smokers and nonsmokers.
...
```{r code-for-prob-1e, inlcude=FALSE}
...
Type your answer to this problem here. (Do  *not* include R ouptut; answers should be in paragraph form instead.)
...
```{r codde-for-prob-1f, include=FALSE}
